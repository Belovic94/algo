...
public abstract class Personaje implements Atacable{
	...
	protected AtaqueEspecial unaTecnica;
    ...
    public abstract  void atacarAPersonaje(Atacable unPersonaje);
		 
		 
    
    public   void atacarAConAtaqueEspecial(Tablero tablero, Celda unaPosicion){
    	if (unaPosicion.esta_vacia()){
			throw new ExcepcionCeldaVacia("La celda esta vacia");
		}
		if (tablero.obtenerDistancia(posicion, unaPosicion) > this.obtenerDistanciaDeAtaque()){
		...
		atacarAPersonaje(unaPosicion.obtener_personaje());
    }
    
    public void recibirDanio(Masenko tecnica){
		 this.puntosDeVida =tecnica.devolverDanioProducidoEnLaVida(this.puntosDeVida );
	  }
